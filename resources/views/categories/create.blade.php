<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-white-400 leading-tight">
    ...
    <div>
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="rounded-xl bg-navy p-6 ring-1 ring-gray-700">
                <form action="{{ route('categories.store') }}" method="post" id="form">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="name" type="text" name="name" class="w-full block mt-1"
                                required />
